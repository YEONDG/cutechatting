...
export default function Home() {
  return (
    <div className="flex flex-col items-center">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center space-y-4 rounded-lg bg-gray-50 p-6">
              ...
              <h3 className="text-xl font-bold">좋아요 기능</h3>
            ...
            <div className="flex flex-col items-center space-y-4 rounded-lg bg-gray-50 p-6">
              ...
              <h3 className="text-xl font-bold">태그 기능</h3>
              <p className="text-center text-gray-500">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-gray-500">등록된 아스키 아트</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-4xl font-bold">5+</h3>
              <p className="text-gray-500">활성 사용자</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-4xl font-bold">5+</h3>
              <p className="text-gray-500">태그 카테고리</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA 섹션 */}
      <section className="w-full bg-indigo-600 py-12 text-white md:py-24">
        <div className="container mx-auto flex flex-col items-center space-y-4 px-4 text-center md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">
            지금 바로 시작하세요
          </h2>
